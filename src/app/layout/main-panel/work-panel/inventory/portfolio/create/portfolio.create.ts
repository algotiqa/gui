...
export class PortfolioCreatePanel extends AbstractPanel {
  ...
  constructor(eventBusService          : EventBusService,
    ...
    super.subscribeToApp(AppEvent.PORTFOLIO_CREATE_START, (e : AppEvent) => this.onStart(e));
