...
export class BrokerProductList extends AbstractPanel {
  ...
  setupColumns = () => {
    ...
    this.columns = [
      new FlexTableColumn(bp, "symbol"),
      new FlexTableColumn(bp, "name"),
      new FlexTableColumn(bp, "marketType", new LabelTranscoder(this.labelService, "map.market")),
      new FlexTableColumn(bp, "exchangeCode"),
      new FlexTableColumn(bp, "marginValue"),
